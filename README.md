...
- 개발 기간 : 2022.12.14 ~ 2023.01.16
- 개뱔 인원 : 7명
- 역할 : 판매자 프론트 및 백엔드 / 관리자 정산 백엔드 / 계좌등록 백엔드
...
# 💡 기능 요약
> ## 구매자
 - 후원하기 또는 리워드 선택 후 결제창 이동
 - 전화번호 정보 없을 시 문자인증 후 전화번호 등록
 - 우편번호 API를 이용해 주소 등록
 - 결제 API를 이용하여 결제
 - 결제성공 시 결제완료창 이동
 - 마이페이지 : 회원정보 수정 및 탈퇴, 내가쓴 댓글보기, 1:1 문의, 관심 프로젝트 목록, 내가 후원한 프로젝트 목록


### 　　
> ## [판매자](#프로젝트-상세) 🙋(본인참여)
 - 프로젝트 상세 내용, 프로젝트 진행 현황
 - 좋아요 기능
 - url 복사, 페이스북, 트위터, 카카오 공유하기 기능
 - [판매자 공지사항 작성](#4.-알림-🙋(본인참여)) 🙋
 - 사용자 문의/응원/후기 댓글 작성 & 판매자 답글 작성 🙋
 - 프로젝트 및 댓글 신고하기 기능 🙋
 - 마이페이지 : 나의 프로젝트 목록, 주문배송 관리 기능
 - 금융결제원 오픈뱅킹 API를 이용한 계좌등록 기능 🙋

###
 - 프로젝트 만들기 : 사전 유의사항 체크 및 본인인증 🙋(본인참여), 프로젝트 정보, 일정, 스토리, 리워드, 정책, 판매자 정보 작성


### 　　
> ## 관리자
 - 관리자 페이지 메인 : 프로젝트 달성률 차트, 구매/판매/블랙리스트 회원비율 차트, 최근 신고 알림, 최근 승인요청 프로젝트 
 - 고객센터 : 공지사항, 1:1 문의, FAQ 게시판 목록 작성, 조회, 수정, 삭제
 - 프로젝트 승인 : 요청된 프로젝트 승인/반려 목록, 프로젝트 정보 상세보기 및 프로젝트 미리보기
 - 프로젝트 목록 : 승인된 프로젝트 진행중/마감/중지 목록
 - 정산이체 : 달성마감된 프로젝트 정산이체 기능 🙋(본인참여)
 - 신고목록 : 신고된 회원 및 프로젝트 목록, 블랙리스트 전환 기능
 - 회원목록 : 회원정보 상세보기, 구매/판매/블랙리스트 구분
...
###
### 3. 프로젝트 소개
![녹화_2023_02_14_11_50_09_306](https://user-images.githubusercontent.com/104848301/218626404-0b35e3e1-b73e-48ad-b58c-149b0994e7cd.gif)
###
...
### 2. 회원 탈퇴
![녹화_2023_02_14_16_38_38_61](https://user-images.githubusercontent.com/104848301/218670512-ff8fc93e-ecb1-46dc-8904-cf45e3a0a077.gif)
###
...
### 6. 판매회원 계좌 등록  🙋(본인참여)
- 판매회원은 정산을 받기위한 계좌를 등록

###
![녹화_2023_02_14_17_23_37_3](https://user-images.githubusercontent.com/104848301/218680430-a24d1a90-85c4-40fa-a52a-cecb2e8f5d54.gif)
###
...
### 1. 공지사항
![녹화_2023_02_14_15_27_21_36](https://user-images.githubusercontent.com/104848301/218656924-940ed6a2-4892-46a3-9630-e1a2d6b57939.gif)
###

### 2. FAQ
- 사용자가 자주하는 질문에 대한 답변을 작성
###
![녹화_2023_02_14_15_31_47_587](https://user-images.githubusercontent.com/104848301/218657810-66bc8fa1-cbab-486f-ad2b-9804e0060b2f.gif)
###
- 사용자 페이지의 FAQ
###
...
- FAQ 삭제
###
![녹화_2023_02_14_15_34_29_310](https://user-images.githubusercontent.com/104848301/218658018-6cf42e2a-7da6-479a-abc8-294e7e36dda8.gif)
###
...
### 6. 정산관리 🙋(본인참여)
- 목표금액을 달성하면서 마감된 프로젝트 목록
- 수수료 제외한 금액 정산 이체

###
![녹화_2023_02_14_17_10_35_463](https://user-images.githubusercontent.com/104848301/218677006-a328bb7a-b09f-41cb-8ca2-f7407a441307.gif)
###
