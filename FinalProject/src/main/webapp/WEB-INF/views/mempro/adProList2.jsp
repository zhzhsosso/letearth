...
<div style="padding-top: 30px; padding-bottom: 30px;"></div>
							...
							<table class="table table-hover">
								<tbody>
									<tr style="background-color: #EDEAE0">
										...
										<th
											style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">달성률</th>
										<th
											style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">프로젝트
											상태</th>
									</tr>
									...
									<tbody>
										...
										<c:forEach var="proVO5" items="${proList }">
											<c:if test="${proVO5.pro_status == 5}">
												<tr>
													<td
														style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">${proVO5.pro_no }</td>
													<td
														style="font-size: 15px; color: #414934; font-weight: bold;"><a
														href="/mempro/adProDetail2?pro_no=${proVO5.pro_no }&mem_id=${proVO5.mem_id}"
														style="color: green"> ${proVO5.pro_title } </a></td>
													<td
														style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">${proVO5.mem_id }</td>
													<fmt:parseDate value="${proVO5.pro_st_dt }" var="str_Date5" pattern="yy-MM-dd" />
												<td style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">
												<fmt:formatDate value="${str_Date5}" pattern="yy-MM-dd"/></td>
													<td
														style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;"><fmt:formatNumber
									...
									<tbody>
										...
										<c:forEach var="proVO6" items="${proList }">
											<c:if test="${proVO6.pro_status == 6}">
												<tr>
													<td
														style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">${proVO6.pro_no }</td>
													<td
														style="font-size: 15px; color: #414934; font-weight: bold;"><a
														href="/mempro/adProDetail2?pro_no=${proVO6.pro_no }&mem_id=${proVO6.mem_id}"
														style="color: green"> ${proVO6.pro_title } </a></td>
													<td
														style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">${proVO6.mem_id }</td>
													<fmt:parseDate value="${proVO6.pro_st_dt }" var="str_Date6" pattern="yy-MM-dd" />
												<td style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">
												<fmt:formatDate value="${str_Date6}" pattern="yy-MM-dd"/></td>
													<td
														style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;"><fmt:formatNumber
									...
									<tbody>
										...
										<c:forEach var="proVO7" items="${proList }">
											<c:if test="${proVO7.pro_status == 7}">
												<tr>
													<td
														style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">${proVO7.pro_no }</td>
													<td
														style="font-size: 15px; color: #414934; font-weight: bold;"><a
														href="/mempro/adProDetail2?pro_no=${proVO7.pro_no }&mem_id=${proVO7.mem_id}"
														style="color: green"> ${proVO7.pro_title } </a></td>
													<td
														style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">${proVO7.mem_id }</td>
													<fmt:parseDate value="${proVO7.pro_st_dt }" var="str_Date7" pattern="yy-MM-dd" />
												<td style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;">
												<fmt:formatDate value="${str_Date7}" pattern="yy-MM-dd"/></td>
													<td
														style="font-size: 15px; text-align: center; color: #414934; font-weight: bold;"><fmt:formatNumber
				...
				<div class="pagination"
					...
					<ul class="pagination" style="font-size: 18px;">
						<c:if test="${pvo.prev }">
							<li class="paging"><a
								href="adProList2${pvo.makeSearch(pvo.starPage-1) }">«</a></li>
							<!-- 10 -->
						</c:if>
						...
						<c:forEach var="idx" begin="${pvo.startPage }"
							...
							<li class="paging"
								...
								href="adProList2${pvo.makeSearch(idx) }">${idx }</a></li>
						</c:forEach>

						<c:if test="${pvo.next }">
							<li class="paging"><a
								href="adProList2${pvo.makeSearch(pvo.endPage+1) }">»</a></li>
							<!-- 11 -->
						</c:if>
					</ul>
				</div>
...
<script type="text/javascript">
	$(function() {
		$('#searchBtn').click(
				function() {
					self.location = "adProList2" + '${pvo.makeQuery(1)}'
							+ "&searchType="
