<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <section class="contact-form-area">
        <div class="container" style="margin-top: 110px; margin-bottom: 110px;">
            ...
            <div class="section-title text-center">
                  <span>가입하셨던 아이디, 이름, 이메일을 입력해주세요!</span>
            </div>
            
            <div class="row justify-content-center">
                <div class="col-lg-8">
                
                    <form id="contact-form" action="/member/findPw" method="post">
                        <div class="conact-form-item">
                            <div class="row" style="flex-direction: column; align-items: center;">
                                ...
                                <div class="input-box mt-20 text-center">
                                        <button class="main-btn" type="submit">비밀번호 찾기</button>
                                        <button class="main-btn" type="button" onclick="location.href='/member/findId'">아이디 찾기</button>
                                    </div>
                                </div>
