								...
								<div class="item">
									...
									<div class="modal fade" id="myModal" tabindex="-1"
										...
										<div class="modal-dialog modal-lg modal-dialog-scrollable"
											...
											② 본 기준에서는 본 조에서 정한 용어가 우선적으로 적용되며, 본 조에서 정의되지 않은 용어는 텀블벅 이용약관 및 관련 법령·관습에 따릅니다.<br>
											<br>
											...
											⑤ 후원자에게 선물을 전달할 방법(배송, 현장 수령, 텀블벅 메시지 등)을 명시해야 하며, 선물 수령을 위해 추후 후원금 외 별도 비용이나 불필요한 타서비스 가입, 개인 정보 등을 요구할 수 없습니다.<br>
											...
											③ 텀블벅 또는 타 크라우드 펀딩 플랫폼에서 앞서 진행한 프로젝트가 있는 창작자는 다음과 같은 경우 새 프로젝트 진행이 제한됩니다. 본 항의 진행 제한은 계정 단위가 아닌 창작자 단위로 이루어집니다.<br>
											...
											<p>
											① 아래 선물들은 텀블벅의 취지, 커뮤니티의 안전, 현행법 준수를 위해 제공할 수 없습니다.<br>
											...
											<p>
											① 후원자 대상 공지나 문의 처리 등의 소통을 위해 텀블벅 커뮤니티와 메시지 기능을 우선적으로 사용하여야 하며, 외부 채널을 주된 문의처로 기재할 수 없습니다.<br>
