						...
						<form method="post" name="fr">
					    	<div class="modal-dialog modal-lg" role="document">
					        	<div class="modal-content">
				                    ...
				                    배송 여부<br>
									<div class="select">
										<input type="radio" id="select" name="reward_ship" value="배송"><label for="select" style="position: inherit;">배송</label>
										<input type="radio" id="select2" name="reward_ship" value="배송안함"><label for="select2" style="position: inherit;">배송안함</label>
									</div>
				                    발송 시작일<br>
						        ...
						        <small> · 종료일 + 11개월까지 리워드 발송이 시작되지 않은 경우, 미발송 상태인 서포터의 펀딩금 반환이 자동으로 완료 처리(결제 취소)되니 유의해 주세요.</small><br>
								<br>
						         	<div id="buttons">
