...
//	
//	private String cntr_account_type; //“N”:계좌, “C”:계정
//	private String cntr_account_num; //관리자(아마) 계좌번호
//	private String wd_pass_phrase; //입금이체용 암호문구
//	private String wd_print_content; //출금계좌인자내역 
//	private String name_check_option; //수취인성명 검증 여부 
//	private String tran_dtime; //요청일시
//	private String req_cnt; //입금요청건수 , 1건만 가능
//	private List<DepositVO> req_list; //입금요청 목록
